...
import imgBestSeller2 from '../../assets/imageHome/imgBestSeller2.png'
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="95" viewBox="0 0 40 95" fill="none">
        ...
        <path d="M18.3333 51.1667L22.5 47.0001L18.3333 42.8334" stroke="black" stroke-linecap="round" />
      </svg>
    </div>
  );
}
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="95" viewBox="0 0 40 95" fill="none">
        ...
        <path d="M21.6667 43.8333L17.5 47.9999L21.6667 52.1666" stroke="black" stroke-linecap="round" />
      </svg>
    </div>
  );
}
